...
(function() {
  ...
  if (!(detectBrowser().isSafari && window.innerWidth < 900)) {
    ...
    function validate(element, form) {
      ...
      ); // check VAT checkbox in document range NOT in form range
          ...
          addressSelect.addEventListener("change", () => {
            ...
            activeMessageContainers.forEach(activeMessageContainer => {
              ...
              const activeMessages = Array.from(
                activeMessageContainer.querySelectorAll(
